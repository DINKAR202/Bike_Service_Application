...
const Contact = () => {
    ...
    const onSubmit = data => {
        ...
        emailjs.send('service_th9o44d', 'template_gyapnx9', data, '6kUK2PlGJYN76E1rE')
            .then((res) => {
                            ...
                            <Row>
                                <Col md="6">
                                    <div className="contact-group">
                                        ...
                                        <input type="text"  name="from_name" placeholder="Enter Your Name"  {...register("from_name", { required: true })} required />
                                    </div>

                                    <div className="contact-group"  >
                                        <label>Email</label>
                                        <input type="email" name="email_id" placeholder="Enter Your Email"  {...register("email_id", { required: true })} required />
                                    </div>

                                    <div className="contact-group">
                                        <label>Phone</label>
                                        <input type="phone" name="phone_number" placeholder="Enter Your Phone Number"  {...register("phone_number", { required: true })} required  />
                                    </div>  
                                </Col>
