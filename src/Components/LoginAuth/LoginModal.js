                ...
                <div className={newUser ? "cont s--signup" : "cont"}>
                    <div className="form sign-in">
                        ...
                        <form onSubmit={handleSignIn(onSubmit)}>
                            <label>
                                <span>Email</span>
                                <input defaultValue="demo@admin.com" {...registerSignIn("email", { required: true })} type="email" />
                            </label>
                            <label>
                                <span>Password</span>
                                <input defaultValue="123698" {...registerSignIn("password", { required: true })} type="password" />
                            </label>
