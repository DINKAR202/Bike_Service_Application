...
const BookList = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:9090/orderedByEmail?email=" + loggedInUser.email) // Replace with your actual API URL
      .then((res) => {
        setOrders(res.data);
      })
  ...
  const handleDeleteService = (id) => {
    ...
    swal({
      ...
      if (wantDelete) {
        ...
        axios
          .delete(`http://localhost:9090/cancel-order/${id}`) // Replace with your actual API URL
          .then((res) => {
